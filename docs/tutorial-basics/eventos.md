...
Se usa para medir cuando un usuario ingresa a la App a través de un deeplink. Registra la campaña y canal de origen, y dependiendo del tipo de destino del deeplink puede incluir información del producto, categoría o fabricante al que apunta.
